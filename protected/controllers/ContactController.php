...
class ContactController extends Controller {
    ...
    public function actionSaveContact() {
        ...
        $subject=' Contact kuteshop : '.Yii::app()->request->getPost("title").'';
        if ($model->save()) {
           $this-> mailsend("lethuylinhleloi@gmail.com", Yii::app()->request->getPost("email"),$subject, $message);
        }  else {
                echo '0';
            }
    }
    ...
    static function mailsend($to, $from, $subject, $message) {
        ...
        $mail->SetFrom($from,'lethuylinhleloi@gmail.com');

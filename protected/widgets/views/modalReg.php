            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="rows">
                     ...
                     <ul>
                       ...
                       <li class="row">
                          <div class="col-sm-6"> 
                           ...
                           <input id="telephone_reg" type="password" class="form-control">
                           <label id="err_telephone_reg"  style="color: red" >Số Điện Thoại k được trống </label>
                            <label id="validate_telephone_reg"  style="color: red" >Số Điện Thoại k đúng </label>
                           </div>
                       </li>
                       <li class="row">
                          <div class="col-sm-6"> 
                  ...
                  <p id="reg_succ">Đăng ký  thành công!</p>  
                </div>
              </div>
